...
const Navbar = () => {
    return (
        <div>
            <div>
                <div className='side-bar w-25 bg-success d-flex justify-content-center flex-column align-items-center'>
                    <div className='mb-5'>
                    ...
                    <ul class="nav nav-pills flex-column mb-auto ">
                        <li>
                            <a href="/" class="nav-link link-body-emphasis active text-white fs-4 d-flex  align-items-center  ">
